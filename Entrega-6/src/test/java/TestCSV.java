...
public class TestCSV {
    ...
    ServicioTransporte colectivo = new ServicioTransporte(MedioDeTransporte.SUBTE); // TODO: eliminar
    ServicioTransporte ecobici = new ServicioTransporte(MedioDeTransporte.SUBTE); // TODO: eliminar
